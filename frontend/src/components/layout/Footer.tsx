...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-300 transition-colors duration-200">
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+254799954672" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-white transition-colors">
                  +254 799 954 672
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-primary-600 dark:text-primary-500" />
                <a href="mailto:support@ementech.co.ke" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-white transition-colors">
                  munenendegwa6@gmail.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 p-2 rounded-full hover:bg-primary-600 hover:text-white transition-colors"
        ...
        {/* Legal Links (desktop) */}
        <div className="hidden lg:flex items-center justify-between mt-12 pt-8 border-t border-gray-300 dark:border-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              <Shield className="h-8 w-8 text-primary-600 dark:text-primary-500 mb-2" />
              <h4 className="text-gray-900 dark:text-white font-semibold mb-1">Secure Payments</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">M-Pesa integration with escrow protection</p>
            </div>
            <div className="flex flex-col items-center">
              <Users className="h-8 w-8 text-primary-600 dark:text-primary-500 mb-2" />
              <h4 className="text-gray-900 dark:text-white font-semibold mb-1">Verified Technicians</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">All professionals vetted and rated</p>
            </div>
            <div className="flex flex-col items-center">
              <MessageCircle className="h-8 w-8 text-primary-600 dark:text-primary-500 mb-2" />
              <h4 className="text-gray-900 dark:text-white font-semibold mb-1">24/7 Support</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">We're here to help anytime</p>
            </div>
          </div>
        </div>
      </div>
