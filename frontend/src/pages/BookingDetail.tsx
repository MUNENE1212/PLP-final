      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">{booking.serviceType}</p>
          </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 font-medium capitalize text-gray-900">{booking.urgency}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-2">
              <p className="text-gray-900">{booking.serviceLocation.address}</p>
